# DelMoro's Graphical User Interface 
...
![DelMoro-GUI](../img/DelMoro-GUI.png)
...
![DelMoro-GUI-Exec](../img/DelMoro-GUI-exec.png)
...
!!!TIP 
    User could only download the `EXECUTABLE` DelMoro-GUI, than downloading the whole source code.
