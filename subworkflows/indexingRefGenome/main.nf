...
include {createIndex;createIndexBWAMEM2; createDictionary; createIndexSamtools} from '../../modules/3_ReferenceIndexing' 
...
take:
  ...
  main: 
  if (params.exec != null && params.reference != null && params.aligner == null) {
	...
	} else if (params.exec != null && params.reference != null && params.aligner == "bwamem2") {
     		DelMoroINXRefenceOutput()
